...
//   const finalizeVersionWithLabel = (label) => {
//     const versionName = `Version ${Object.keys(docVersions).length}`;
//     setDocVersions((prev) => ({
//       ...prev,
//       [versionName]: {
//         content: pendingDelta.delta,
//         label: label || "Refinement",
//       },
//     }));
//     setSelectedVersion(versionName);
//     setPendingDelta("");
...
//                         onClick={() => {
//                           setModalMode("rename");
//                           setRenameTarget(selectedVersion);
//                           setShowLabelModal(true);
//                         }}
//                       >
//                         ✏️ Rename
...
//                         onClick={() => {
//                           const confirmed = window.confirm(`Are you sure you want to delete "${selectedVersion}"?`);
//                           if (confirmed) {
//                             setDocVersions((prev) => {
//                               const updated = { ...prev };
...
//                               const fallback = Object.keys(updated)[0] || "";
//                               setSelectedVersion(fallback);
//                               setEditableContent(updated[fallback]?.content || "");
//                               return updated;
//                             });
//                           }
//                         }}
...
//     defaultLabel={
//       modalMode === "rename" ? docVersions[renameTarget]?.label : ""
//     }
//     onSubmit={(label) => {
//       if (modalMode === "rename") {
//         // rename version
...
//   const [showLabelModal, setShowLabelModal] = useState(false);
//   const [pendingChatResponse, setPendingChatResponse] = useState(null);
...
//       const userLabel = prompt("📌 Add a label for this new version:");
